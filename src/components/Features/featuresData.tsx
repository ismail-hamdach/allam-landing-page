...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Every child has a tailored learning experience based on their proficiency and preferences. From vocabulary to grammar, the content evolves as your child progresses.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Engage your child with games, quizzes, and exercises that make learning exciting and effective, from the alphabet to advanced reading.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Our platform tracks your child’s progress and offers recommendations to improve weak areas, ensuring steady growth.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Stay involved with regular updates on your child’s achievements, challenges, and areas for improvement.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Learning happens anytime, anywhere. Whether in the morning or evening, your child can learn at their own pace.",
  },
  {
    id: 1,
    icon: (
